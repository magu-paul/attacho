...
<sql:query var="rs" dataSource="${db}">select * from cohort</sql:query>

<table style="width:auto; border: 2px solid black">
<th style="width:auto; border: 1px solid black">Name </th>
<th style="width:auto; border: 1px solid black">LAW</th>
<th style="width:auto; border: 1px solid black">SANRM</th>
<th style="width:auto; border: 1px solid black">SASS</th>
<th style="width:auto; border: 1px solid black">SEHURED</th>
<th style="width:auto; border: 1px solid black">SHS</th>
<th style="width:auto; border: 1px solid black">SIST</th>
<th style="width:auto; border: 1px solid black">SOBE</th>
<th style="width:auto; border: 1px solid black">SPAS</th>
<th style="width:auto; border: 1px solid black">Diploma</th>
<th style="width:auto; border: 1px solid black">Degree</th>

 
 <c:forEach items="${rs.rows}" var="row">e
 <tr style="width:auto; border: 1px solid black">
 <td ><c:out value="${row.session}"></c:out></td>
 <td ><c:out value="${row.LAW}"></c:out></td>
 <td ><c:out value="${row.SANRM}"></c:out></td>
 <td><c:out value="${row.SASS}"></c:out></td>
 <td><c:out value="${row.SEHURED}"></c:out></td>
 <td><c:out value="${row.SHS}"></c:out></td>
 <td><c:out value="${row.SIST}"></c:out></td>
 <td ><c:out value="${row.SOBE}"></c:out></td>
 <td ><c:out value="${row.SPAS}"></c:out></td>
 <td ><c:out value="${row.diploma}"></c:out></td>
 <td ><c:out value="${row.degree}"></c:out></td>
 <td style="width:auto; border: 1px solid black"><form method="post" action="removeSession"><button type = submit name="session" value='${row.session}'>Remove</button></form></td>
 </tr>
 </c:forEach>
	</table>
                                </div>
