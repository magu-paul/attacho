...
<sql:query var="rs" dataSource="${db}">select s.fname,s.lname,su.regno,su.station,su.company,phone,su.staff from stud_users su join student s using(regno)</sql:query>
...
<th style="width:auto; border: 1px solid black">Lecturer Staff No</th>
 ...
 <td><c:out value="${row.staff}"></c:out></td>
