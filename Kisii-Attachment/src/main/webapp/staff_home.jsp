		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ms-auto">
					...
					<li class="nav-item mx-0 mx-lg-1"><a
						class="nav-link py-3 px-0 px-lg-3 rounded" href="staff_profile.jsp">My Profile</a></li>
				</ul>
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-4 ms-auto">
					<p class="lead">The Kisii University Attachment System is an online platform that enables staff members to assess students online</p>
				</div>
				<div class="col-lg-4 me-auto">
					<p class="lead">However staff still have to visit students in their physical location. Staff are equipped with online tools to complete assessment 
